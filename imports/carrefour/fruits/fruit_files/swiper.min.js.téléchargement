    ...
    var v = {
        ...
        setTranslate: function(e, t) {
            var i = this.rtlTranslate,
                ...
                n = 0,
                o = 0;
            this.isHorizontal() ? n = i ? -e : e : o = e, s.roundLengths && (n = Math.floor(n), o = Math.floor(o)), s.virtualTranslate || (h.transforms3d ? a.transform("translateX(" + n + "px) translateY(" + o + "px) translateZ(0px)") : a.transform("translate(" + n + "px, " + o + "px)")), this.translate = this.isHorizontal() ? n : o;
    ...
    var G = {
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    ...
                    if ("fraction" === t.type && (r.find("." + t.currentClass).text(i + 1), r.find("." + t.totalClass).text(n)), "progressbar" === t.type) {
                        var g = (i + 1) / n,
                            b = g,
                            w = 1;
                        this.isHorizontal() || (w = g, b = 1), r.find("." + t.progressbarFillClass).transform("translateX(0) translateY(0) translateZ(0) scaleX(" + b + ") scaleY(" + w + ")").transition(this.params.speed)
                    }
            ...
            setTranslate: function() {
                if (this.params.scrollbar.el && this.scrollbar.el) {
                    var e = this.scrollbar,
                        ...
                        l = s,
                        d = (a - s) * i;
                    t ? (d = -d) > 0 ? (l = s - d, d = 0) : -d + s > a && (l = a + d) : d < 0 ? (l = s + d, d = 0) : d + s > a && (l = a - d), this.isHorizontal() ? (h.transforms3d ? r.transform("translateX(" + d + "px) translateY(0) translateZ(0)") : r.transform("translateX(" + d + "px)"), r[0].style.width = l + "px") : (h.transforms3d ? r.transform("translateX(0px) translateY(" + d + "px) translateZ(0)") : r.transform("translateY(" + d + "px)"), r[0].style.height = l + "px"), o.hide && (clearTimeout(this.scrollbar.timeout), n[0].style.opacity = 1, this.scrollbar.timeout = setTimeout(function() {
        ...
        R = {
            setTransform: function(e, t) {
                ...
                if (void 0 === d || null === d) a.transform("translateX(" + o + ") translateY(" + l + ") translateZ(0px)");
                else {
                    var c = d - (d - 1) * (1 - Math.abs(t));
                    a.transform("translateX(" + o + ") translateY(" + l + ") translateZ(0px) scale(" + c + ")")
                }
            },
            setTranslate: function() {
                var e = this,
        ...
        F = {
            ...
            onGestureChange: function(e) {
                ...
                s.$imageEl && 0 !== s.$imageEl.length && (h.gestures ? this.zoom.scale = e.scale * i.currentScale : i.scale = s.scaleMove / s.scaleStart * i.currentScale, i.scale > s.maxRatio && (i.scale = s.maxRatio - 1 + Math.pow(i.scale - s.maxRatio + 1, .5)), i.scale < t.minRatio && (i.scale = t.minRatio + 1 - Math.pow(t.minRatio - i.scale + 1, .5)), s.$imageEl.transform("translateX(0) translateY(0) translateZ(0) scale(" + i.scale + ")"))
            },
            onGestureEnd: function(e) {
                ...
                s.$imageEl && 0 !== s.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, s.maxRatio), t.minRatio), s.$imageEl.transition(this.params.speed).transform("translateX(0) translateY(0) translateZ(0) scale(" + i.scale + ")"), i.currentScale = i.scale, i.isScaling = !1, 1 === i.scale && (s.$slideEl = void 0))
            },
            ...
            onTouchMove: function(e) {
                ...
                if (i.$imageEl && 0 !== i.$imageEl.length && (this.allowClick = !1, s.isTouched && i.$slideEl)) {
                    ...
                    if (!(r < i.slideWidth && n < i.slideHeight)) {
                        ...
                        e.preventDefault(), e.stopPropagation(), s.isMoved = !0, s.currentX = s.touchesCurrent.x - s.touchesStart.x + s.startX, s.currentY = s.touchesCurrent.y - s.touchesStart.y + s.startY, s.currentX < s.minX && (s.currentX = s.minX + 1 - Math.pow(s.minX - s.currentX + 1, .8)), s.currentX > s.maxX && (s.currentX = s.maxX - 1 + Math.pow(s.currentX - s.maxX + 1, .8)), s.currentY < s.minY && (s.currentY = s.minY + 1 - Math.pow(s.minY - s.currentY + 1, .8)), s.currentY > s.maxY && (s.currentY = s.maxY - 1 + Math.pow(s.currentY - s.maxY + 1, .8)), a.prevPositionX || (a.prevPositionX = s.touchesCurrent.x), a.prevPositionY || (a.prevPositionY = s.touchesCurrent.y), a.prevTime || (a.prevTime = Date.now()), a.x = (s.touchesCurrent.x - a.prevPositionX) / (Date.now() - a.prevTime) / 2, a.y = (s.touchesCurrent.y - a.prevPositionY) / (Date.now() - a.prevTime) / 2, Math.abs(s.touchesCurrent.x - a.prevPositionX) < 2 && (a.x = 0), Math.abs(s.touchesCurrent.y - a.prevPositionY) < 2 && (a.y = 0), a.prevPositionX = s.touchesCurrent.x, a.prevPositionY = s.touchesCurrent.y, a.prevTime = Date.now(), i.$imageWrapEl.transform("translateX(" + s.currentX + "px) translateY(" + s.currentY + "px) translateZ(0)")
                    }
                }
            },
            onTouchEnd: function() {
                ...
                if (t.$imageEl && 0 !== t.$imageEl.length) {
                    ...
                    var p = i.width * e.scale,
                        c = i.height * e.scale;
                    i.minX = Math.min(t.slideWidth / 2 - p / 2, 0), i.maxX = -i.minX, i.minY = Math.min(t.slideHeight / 2 - c / 2, 0), i.maxY = -i.minY, i.currentX = Math.max(Math.min(i.currentX, i.maxX), i.minX), i.currentY = Math.max(Math.min(i.currentY, i.maxY), i.minY), t.$imageWrapEl.transition(h).transform("translateX(" + i.currentX + "px) translateY(" + i.currentY + "px) translateZ(0)")
                }
            },
        ...
        Q = {
            setTranslate: function() {
                ...
                for (var u = 0; u < a.length; u += 1) {
                    ...
                    var E = "rotateX(" + (h ? 0 : -m) + "deg) rotateY(" + (h ? m : 0) + "deg) translateX(" + w + "px) translateY(" + y + "px) translateZ(" + x + "px)";
                ...
                if (i.css({
                    ...
                    if (h) e.transform("translateX(0px) translateY(" + (r / 2 + d.shadowOffset) + "px) translateZ(" + -r / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + d.shadowScale + ")");
                    else {
                        var M = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
                            ...
                            k = d.shadowScale / z,
                            $ = d.shadowOffset;
                        e.transform("scale3d(" + P + ", 1, " + k + ") translateX(0px) translateY(" + (n / 2 + $) + "px) translateZ(" + -n / 2 / k + "px) rotateX(-90deg)")
                    }
                var L = S.isSafari || S.isUiWebView ? -l / 2 : 0;
                i.transform("translateX(0px) translateY(0) translateZ(" + L + "px) rotateX(" + (this.isHorizontal() ? 0 : c) + "deg) rotateY(" + (this.isHorizontal() ? -c : 0) + "deg)")
            },
            setTransition: function(e) {
                var t = this.$el;
        ...
        J = {
            setTranslate: function() {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    a.transform("translateX(" + l + "px) translateY(" + d + "px) translateZ(0px) rotateX(" + o + "deg) rotateY(" + n + "deg)")
                }
            },
            setTransition: function(e) {
                var t = this,
        ...
        ee = {
            setTranslate: function() {
                for (var e = this.width, t = this.height, i = this.slides, a = this.$wrapperEl, r = this.slidesSizesGrid, n = this.params.coverflowEffect, o = this.isHorizontal(), l = this.translate, d = o ? e / 2 - l : t / 2 - l, p = o ? n.rotate : -n.rotate, c = n.depth, u = 0, v = i.length; u < v; u += 1) {
                    ...
                    var T = "translateX(" + E + "px) translateY(" + x + "px) translateZ(" + y + "px)  rotateX(" + w + "deg) rotateY(" + b + "deg)";
